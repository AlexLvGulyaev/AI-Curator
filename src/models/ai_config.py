...
class AiConfig(Base):
    ...
    active_provider: Mapped[str] = mapped_column(String(50), nullable=False, default="openai")
    fallback_provider: Mapped[str] = mapped_column(String(50), nullable=False, default="gigachat")
    openai_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    gigachat_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
