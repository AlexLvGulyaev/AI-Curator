...
const CHART_TOOLTIPS = {
  'Распределение по темам': 'Распределение запросов по intent-классификации: учёба, дедлайн, прогресс, смешанный, организационные, не распределено и ошибки.',
  'Источники ответов': 'Откуда взялся ответ: LMS, База знаний, Кэш, Fallback бэкенда (например, не распределено) или технические ошибки.',
