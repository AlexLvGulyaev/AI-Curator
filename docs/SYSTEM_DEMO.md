...
### 🎚️ Переключатель уровня сложности
...
## 🎛️ 3. Консоль администратора

🌐 **Администратору:** [▶️ Открыть консоль администратора](https://curator-admin.alex-n8n.site)
