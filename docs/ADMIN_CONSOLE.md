...
| 2026-08-05 | 1.1 | Актуализировано под текущий состав панелей (Analytics, Reports, Logs, Dialog Sessions, Audit, export); добавлена обратная ссылка на `ADMIN_GUIDE.md` |
