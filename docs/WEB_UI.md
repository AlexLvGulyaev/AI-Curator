...
Web UI AI Curator — отдельный публичный frontend-сервис для студентов. Он предоставляет чат с AI-куратором, позволяет задавать организационные и учебные вопросы, получать ответы с источниками и выбирать уровень сложности.
...
- [ ] Добавить оценку полезности ответа.
- [ ] Добавить историю диалога с сохранением в `localStorage`.
- [ ] Подключить LLM для генерации финального ответа на основе RAG + LMS данных.
- [ ] Поддержка markdown-разметки в ответах AI.
