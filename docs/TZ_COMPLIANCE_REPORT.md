...
- [🧪 `docs/TESTING_CONTRACT.md`](TESTING_CONTRACT.md) — правила работы с тестовой БД и тестами.
- [🔍 `src/api/v1/admin/analytics.py`](../src/api/v1/admin/analytics.py) — Analytics endpoints.
- [📈 `admin-console/src/components/Analytics.jsx`](../admin-console/src/components/Analytics.jsx) — UI аналитики.
- [🗄️ PostgreSQL `ai_curator`](ARCHITECTURE.md) — операционная БД: счётчики таблиц, распределение интентов, active AI config.
