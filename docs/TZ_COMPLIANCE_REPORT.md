...
**Проект:** AI Curator — ИИ-куратор для образовательной платформы  
**Дата среза:** 2026-08-04  
**Источник ТЗ:** [ТЗ проекта.md](../ТЗ%20проекта.md)
...
|---------------|--------|-----------|
| Цель: ИИ-куратор для образовательной платформы | **Выполнено** | Развёрнут публичный сервис с Web UI, Admin Console, LMS-интеграцией |
...
|----------|---------------|
| `ТЗ проекта.md` | Требования |
| `README.md` | Публичное описание |
| `docs/SPEC.md` | Продуктовая спецификация |
| `docs/ARCHITECTURE.md` | Архитектурные решения |
| `AI_CURATOR_SYSTEM_SPECIFICATION.md` | Исходная системная спецификация |
