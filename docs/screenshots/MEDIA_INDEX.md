...
| IMG-011 | `AIC_admin_dashboard.png` | admin | Dashboard: health сервисов, KPI за 24ч, активность по интентам, состояние KB | README, SYSTEM_DEMO, ADMIN_GUIDE |
| IMG-012 | `AIC_admin_kb_list.png` | admin | **Общий вид панели Knowledge Base**: слева список документов, справа детальная карточка выбранного документа `PE07. Chain-of-thought` | SYSTEM_DEMO, ADMIN_GUIDE, CURATOR_GUIDE |
...
| IMG-014 | `AIC_admin_kb_upload.png` | admin | Форма загрузки нового документа в Knowledge Base: метаданные и выбор файла `faq-ai-terminology.md` | CURATOR_GUIDE, ADMIN_GUIDE |
| IMG-015 | `AIC_admin_ai_config.png` | admin | AI & Retrieval Configuration: LLM-провайдеры, RAG-параметры, system prompt | ADMIN_GUIDE |
| IMG-016 | `AIC_admin_orchestrator.png` | admin | Orchestrator Configuration: классификация интентов, маршрутизация, fallback-ответы | ADMIN_GUIDE, ORCHESTRATOR_USER_GUIDE |
| IMG-017 | `AIC_admin_analytics.png` | admin | Analytics Dashboard: распределение запросов, источники ответов, latency | SYSTEM_DEMO, ADMIN_GUIDE |
| IMG-018 | `AIC_admin_reports.png` | admin | Business Reports: качество ответов, покрытие KB, вопросы без ответа | SYSTEM_DEMO, ADMIN_GUIDE |
| IMG-019 | `AIC_admin_operational_logs.png` | admin | Operational Logs: список запросов с фильтрами и детализация pipeline | ADMIN_GUIDE, OPERATIONS |
| IMG-020 | `AIC_admin_dialog_sessions.png` | admin | Dialog Sessions: операционная консоль диалогов с таймлайном шагов | ADMIN_GUIDE |
| IMG-021 | `AIC_admin_audit.png` | admin | Audit Log: административные события и детали выбранной записи | ADMIN_GUIDE, SYSTEM_DEMO |
| IMG-022 | `AIC_admin_export_csv.png` | admin | Operational Logs: кнопка `Экспорт CSV` и детальная карточка запроса с таймлайном pipeline | ADMIN_GUIDE, OPERATIONS |
