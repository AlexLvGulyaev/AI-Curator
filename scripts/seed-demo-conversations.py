...
QUESTION_BANK = {
    ...
    "mixed": [
        "Какие уроки есть в первом модуле и в чем суть этих уроков?",
        "Какие темы в курсе и когда их дедлайны?",
        "Что входит в программу курса и в каком порядке это проходить?",
    ],
    "default": [
